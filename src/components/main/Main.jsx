  ...
  return (
    ...
    <div className='main flex-1 relative min-h-[100vh] pb-[1em] px-2 lg:px-5'>
        ...
        <div className='main-container lg:max-w-[900px] m-auto '>
            ...
            <div className='Cards pt-5 pb-0 px-5 flex  overflow-auto  max-w-[22em] lg:max-w-[100%]  w-full gap-5  p-5 '>
            ...
            <div className='main-bottom  bottom-0 w-[100%] max-w-[900px] m-auto pt-0 pr-3 lg:pr-5 fixed '>
                    <div className='search-box flex items-center gap-5 justify-between  bg-[#f0f7f9] rounded-[50px] py-3  px-5    '>
                        <input onChange={(e)=>setinput(e.target.value)}  value={input} className='lg:w-[75%] w-full lg:py-2 lg:px-2 mx-3  py-5 outline-none bottom-0 bg-transparent text-[18px]' type='text' placeholder="Enter a prompt here" />
