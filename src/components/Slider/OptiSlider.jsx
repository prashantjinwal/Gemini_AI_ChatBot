...
function OptiSlider() {
    ...
    const SliderDoor = ()=>{
        ...
        let opti = document.getElementsByClassName("opti-Slider-bar")
        opti.classList.toggle("w-[80%]")

    }

  return (
    <>
    <div className='opti-Slider-bar min-h-[100vh]  py-[1.2em] pr-[1.3em]  pl-[1em]  absolute z-20 flex-col justify-between bg-[#f0f7f9]'>
        <div className='top '> 
